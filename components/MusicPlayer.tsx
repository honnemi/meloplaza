...
export default function MusicPlayer({
  ...
  return (
    <div
      className="w-full min-w-0 rounded-2xl p-3 sm:p-4 border shadow-lg"
      style={{
        background:
    ...
    >
      ...
      <div className="flex items-center gap-3 mb-3 min-w-0">
        {/* CD */}
        <div
          className="w-12 h-12 sm:w-14 sm:h-14 rounded-full shrink-0 relative overflow-hidden shadow-md"
        ...
        {/* LCD readout */}
        <div
          className="flex-1 min-w-0 rounded-md px-2 sm:px-3 py-2 border"
          style={{
            background: "#1E293B",
            borderColor: "#475569",
        ...
        >
          <p
            className="text-[8px] sm:text-[9px] tracking-widest uppercase font-semibold"
            style={{ color: "#60A5FA" }}
          >
            {selectedTrack ? "You selected" : "No disc"}
          </p>
      ...
      {/* Screen */}
      <div
        className="rounded-lg p-1.5 sm:p-2 shadow-[inset_0_4px_12px_rgba(0,0,0,0.25)] border w-full overflow-hidden"
        style={{
          background:
      ...
      >
        {selectedTrack ? (
          <iframe
            ...
            loading="lazy"
            className="rounded shadow-sm block w-full"
          />
        ) : (
          <div
